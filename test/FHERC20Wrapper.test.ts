...
describe("FHERC20Wrapper", function () {
  ...
  describe("wrap balance (ERC20 -> FHERC20)", function () {
    it("Should succeed", async function () {
      ...
      await hre.fhe.mocks.expectPlaintext(await eBTC.confidentialTotalSupply(), transferValue);
  ...
  describe("unwrap & claim balance (FHERC20 -> ERC20)", function () {
    it("Should succeed", async function () {
      ...
      await hre.fhe.mocks.expectPlaintext(await eBTC.confidentialTotalSupply(), mintValue - transferValue);
    });
